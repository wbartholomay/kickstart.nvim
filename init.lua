...
--  Create :Config command to access this config file
...
require('lazy').setup({ -- NOTE: Plugins can be added with a link (or for a github repo: 'owner/repo' link).
  ...
  },
  {
    ...
    config = function()
      ...
      -- Debug: Print the servers table before setup

      -- Skip mason-lspconfig entirely and manually set up each server
